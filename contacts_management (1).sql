...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2018 at 09:08 AM
...
('ram@inmar.com', '1208', 'GEC'),
('ram@inmar.com', '1209', 'LBRCE'),
('ram@inmar.com', '1230', 'IBM'),
('ram@inmar.com', '12456', 'buddy');
...
('abcd adefgh', 'ac@inmar.com', 'abcd@12A', 9856458795, 985645879547),
...
('Ram Krishna', 'ram@inmar.com', 'alla@2697A', 9492585926, 258457896231);
...
INSERT INTO `user_groups` (`UName`, `email_id`, `grp_name`, `group_id`, `phno`) VALUES
('hari', 'hari@inmar.com', 'college', '1204', 9652312368),
('kumar', 'kumar@inmar.com', 'college', '1204', 9492534869),
('dfdf', 'sddfds@inmar.com', 'facebook', '1201', 257854548);
